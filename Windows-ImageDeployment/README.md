# Creating and Deploying a Custom Windows Image With Bootlable USB
...
# Creating and Deploying a Custom Windows Image With ISO 
...
1. **Boot the Reference Computer**:
   - Use a virtual machine software (like Hyper-V, VMware, or VirtualBox) to boot the ISO, or burn the ISO to a DVD and boot the reference computer from it.
